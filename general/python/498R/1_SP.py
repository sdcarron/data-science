...
#Set working directory to desired path BASE DIRECTORY
...
saveDirectory = os.path.join (os.getcwd (), "initialTweet_files") #"initialTweet_Files" is a SUB DIRECTORY of BASE DIRECTORY "IntentDirectory"
